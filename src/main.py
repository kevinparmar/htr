...
from SpellChecker import correct_spelling_pyspellchecker, correct_spelling_textblob, correct_spelling_enchant
...
def infer(model, fnImg):
    ...
    #print("PySpellChecker: ", correct_spelling_pyspellchecker(recognized[0]))
    #print("TextBlob: ", correct_spelling_textblob(recognized[0]))
    print("Enchant: ", correct_spelling_enchant(recognized[0]))
    return recognized[0]
